          ...
          if (typeof str$1 === "number") {
            ...
            switch (str$1.TAG | 0) {
              case /* Bool */0 :
                  ...
                  break;
              case /* String */1 :
                  argv = exitWithError("Invalid --" + name$1 + " value. A boolen flag can have values true/false or no value, got: " + str$1._0);
                  break;
              case /* Float */2 :
                  argv = exitWithError("Invalid --" + name$1 + " value. A boolen flag can have values true/false or no value, got: " + str$1._0.toString());
                  break;
